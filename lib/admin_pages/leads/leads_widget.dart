              ...
              desktop: false,
                ...
                ? AppBar(
                    ...
                    leading: FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'LEADS_PAGE_arrow_back_rounded_ICN_ON_TAP');
                      ...
                      children: [
                        ...
                        StreamBuilder<List<EnquiriesRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<EnquiriesRecord> listViewEnquiriesRecordList =
                                snapshot.data!;
                            return ListView.builder(
                              padding: EdgeInsets.zero,
                              shrinkWrap: true,
                              scrollDirection: Axis.vertical,
                              itemCount: listViewEnquiriesRecordList.length,
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ClipRRect(
                                            ...
                                            child: Image.network(
                                              listViewEnquiriesRecord.userpic,
                                              width: 60.0,
                                              height: 60.0,
                                              fit: BoxFit.cover,
                                            ),
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              FlutterFlowIconButton(
                                                ...
                                                onPressed: () async {
                                                  logFirebaseEvent(
                                                      'LEADS_PAGE_delete_ICN_ON_TAP');
                                                  logFirebaseEvent(
                                                      'IconButton_backend_call');
                                                  await listViewEnquiriesRecord
                                                      .reference
                                                      .delete();
                                                },
                                              ),
