      ...
      if (_model.sessionQueryOnPageLoad?.currentNavJourney == 'newSession') {
        ...
        FFAppState().update(() {
          ...
          FFAppState().selectedMemberLevelName = valueOrDefault<String>(
            ...
            'Starting member level name is not set in company doc',
          );
        });
        logFirebaseEvent('Library-fixed_update_app_state');
        setState(() {
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        FlutterFlowIconButton(
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            logFirebaseEvent('LIBRARY_FIXED_arrow_back_ios_outlined_IC');
                                                                            logFirebaseEvent('IconButton_update_app_state');
                                                                            setState(() {
                                                                  ...
                                                                  Column(
                                                                    ...
                                                                    children: [
                                                                      Builder(
                                                                        builder:
                                                                            (context) {
                                                                          final myTeam = containerMyTeamRecordList
                                                                              .sortedList((e) => e.positionId)
                                                                              .toList();
                                                                          return Row(
                                                                            mainAxisSize:
                                                                                MainAxisSize.max,
