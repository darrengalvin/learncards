                            ...
                            child: StreamBuilder<List<TileBlocksRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final containerTileBlocksRecord =
                                    containerTileBlocksRecordList.isNotEmpty
                                        ? containerTileBlocksRecordList.first
                                        : null;
                                return Container(
              ...
              Column(
                ...
                children: [
                  Align(
                    ...
                    child: Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(5.0, 0.0, 15.0, 0.0),
                      child: Column(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.start,
                        ...
                        children: [
                          StreamBuilder<List<TileBlocksRecord>>(
                            stream: FFAppState().tileBlocksIndex(
                              requestFn: () => queryTileBlocksRecord(
                                queryBuilder: (tileBlocksRecord) =>
