...
class CloudFunctionsGroup {
  ...
  static GetISPDataCall getISPDataCall = GetISPDataCall();
  static GetISPDataCopyCall getISPDataCopyCall = GetISPDataCopyCall();
}
...
class GetISPDataCall {
  Future<ApiCallResponse> call({
    ...
    String? companyName = '',
    String? sessionId = '',
    dynamic? threadDetailsJson,
    String? threadId = '',
    String? userId = '',
  }) async {
    final threadDetails = _serializeJson(threadDetailsJson);
    final response = await makeCloudCall(
      _kPrivateApiFunctionName,
      {
        'callName': 'GetISPDataCall',
        'variables': {
          'username': username,
          'password': password,
          'companyDocId': companyDocId,
