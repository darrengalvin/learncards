...
class BlockStruct extends FFFirebaseStruct {
  BlockStruct({
    String? name,
    String? type,
    int? index,
  ...
  static BlockStruct fromMap(Map<String, dynamic> data) => BlockStruct(
  ...
  static BlockStruct? maybeFromMap(dynamic data) =>
      data is Map ? BlockStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static BlockStruct fromSerializableMap(Map<String, dynamic> data) =>
      BlockStruct(
  ...
  static BlockStruct fromAlgoliaData(Map<String, dynamic> data) => BlockStruct(
  ...
  @override
  String toString() => 'BlockStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is BlockStruct &&
        name == other.name &&
        type == other.type &&
        index == other.index &&
        tier == other.tier &&
...
void addBlockStructData(
  ...
  if (block.firestoreUtilData.delete) {
    firestoreData[fieldName] = FieldValue.delete();
    return;
  }
  final clearFields =
      !forFieldValue && block.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
    firestoreData[fieldName] = <String, dynamic>{};
  }
  final blockData = getBlockFirestoreData(block, forFieldValue);
  final nestedData = blockData.map((k, v) => MapEntry('$fieldName.$k', v));

  final mergeFields = block.firestoreUtilData.create || clearFields;
  firestoreData
      .addAll(mergeFields ? mergeNestedFields(nestedData) : nestedData);
}

Map<String, dynamic> getBlockFirestoreData(
  BlockStruct? block, [
  bool forFieldValue = false,
]) {
  if (block == null) {
  ...
  final firestoreData = mapToFirestore(block.toMap());

  // Add any Firestore field values
  block.firestoreUtilData.fieldValues.forEach((k, v) => firestoreData[k] = v);

  return forFieldValue ? mergeNestedFields(firestoreData) : firestoreData;
}

List<Map<String, dynamic>> getBlockListFirestoreData(
  List<BlockStruct>? blocks,
) =>
    blocks?.map((e) => getBlockFirestoreData(e, true)).toList() ?? [];
