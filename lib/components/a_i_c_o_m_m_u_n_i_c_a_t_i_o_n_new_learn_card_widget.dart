...
import 'a_i_c_o_m_m_u_n_i_c_a_t_i_o_n_new_learn_card_model.dart';
export 'a_i_c_o_m_m_u_n_i_c_a_t_i_o_n_new_learn_card_model.dart';

class AICOMMUNICATIONNewLearnCardWidget extends StatefulWidget {
  const AICOMMUNICATIONNewLearnCardWidget({
    super.key,
    bool? askingQuestion,
  ...
  @override
  State<AICOMMUNICATIONNewLearnCardWidget> createState() =>
      _AICOMMUNICATIONNewLearnCardWidgetState();
}

class _AICOMMUNICATIONNewLearnCardWidgetState
    extends State<AICOMMUNICATIONNewLearnCardWidget>
    with TickerProviderStateMixin {
  late AICOMMUNICATIONNewLearnCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AICOMMUNICATIONNewLearnCardModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('A_I_C_O_M_M_U_N_I_C_A_T_I_O_N_NEW_LEARN_');
      logFirebaseEvent('AI_COMMUNICATION-NewLearnCard_update_com');
      setState(() {
        _model.questionReady = true;
      });
      logFirebaseEvent('AI_COMMUNICATION-NewLearnCard_wait__dela');
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    FlutterFlowIconButton(
                                                      ...
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'A_I_C_O_M_M_U_N_I_C_A_T_I_O_N_NEW_LEARN_');
                                                        logFirebaseEvent(
