...
import 'non_logged_in_warning_copy_model.dart';
export 'non_logged_in_warning_copy_model.dart';

class NonLoggedInWarningCopyWidget extends StatefulWidget {
  const NonLoggedInWarningCopyWidget({super.key});

  @override
  State<NonLoggedInWarningCopyWidget> createState() =>
      _NonLoggedInWarningCopyWidgetState();
}

class _NonLoggedInWarningCopyWidgetState
    extends State<NonLoggedInWarningCopyWidget> {
  late NonLoggedInWarningCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NonLoggedInWarningCopyModel());
                  ...
                  ListView(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'NON_LOGGED_IN_WARNING_COPY_SAVE_MY_PROGR');
                      ...
                      if (valueOrDefault<bool>(
                        valueOrDefault<bool>(
                                currentUserDocument?.hasSyncedProgress,
                                false) ==
                            false,
                        true,
                      ))
                        Padding(
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) => Text(
                              'Great, from now on your progress will be saved, I have sent you an email with details on how to access this in future, In the meantime do not forget to sync your current content and progress. ',
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                    fontFamily: FlutterFlowTheme.of(context)
                          ...
                          child: Visibility(
                            ...
                            child: AuthUserStreamWidget(
                              builder: (context) => FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'NON_LOGGED_IN_WARNING_COPY_MERGE_MY_PROG');
                                  logFirebaseEvent('Button_firestore_query');
                                  _model.tilesWithSessionIdAgaininside1 =
                                      await queryTilesv2RecordOnce(
                                  ...
                                  _model.listOfQuery = _model
                                      .tilesWithSessionIdAgaininside1!
                                      .toList()
                                      .cast<Tilesv2Record>();
                          ...
                          Container(
                            ...
                            child: StreamBuilder<List<Tilesv2Record>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<Tilesv2Record> listViewTilesv2RecordList =
                                    snapshot.data!;
                                return ListView.builder(
                                  padding: EdgeInsets.zero,
                                  shrinkWrap: true,
                                  scrollDirection: Axis.vertical,
                                  itemCount: listViewTilesv2RecordList.length,
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'NON_LOGGED_IN_WARNING_COPY_Container_scl');
