...
class DrawerTileNewWidget extends StatefulWidget {
  const DrawerTileNewWidget({super.key});

  @override
  State<DrawerTileNewWidget> createState() => _DrawerTileNewWidgetState();
}

class _DrawerTileNewWidgetState extends State<DrawerTileNewWidget> {
  late DrawerTileNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DrawerTileNewModel());
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'DRAWER_TILE_NEW_arrow_back_outlined_ICN_');
                                  logFirebaseEvent(
                          ...
                          builder: (context) {
                            if (_model.isEdit) {
                              return InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'DRAWER_TILE_NEW_Icon_rvyaerlb_ON_TAP');
                                  logFirebaseEvent(
                              ...
                              return FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'DRAWER_TILE_NEW_COMP_add_ICN_ON_TAP');
                                  logFirebaseEvent(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'DRAWER_TILE_NEW_Image_g0cfbf6u_ON_TAP');
                                            logFirebaseEvent(
                                          ...
                                          builder: (context) {
                                            if (valueOrDefault<bool>(
                                              ...
                                              return InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'DRAWER_TILE_NEW_Icon_a3stb3jz_ON_TAP');
                                                  logFirebaseEvent(
                                              ...
                                              return InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'DRAWER_TILE_NEW_Icon_dcvgpt0y_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Icon_update_component_state');
                                                  setState(() {
                                                    _model.isEdit = false;
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'DRAWER_TILE_NEW_Text_l1ng4lm0_ON_TAP');
                                                  logFirebaseEvent(
                                                              ...
                                                              if (valueOrDefault<
                                                                ...
                                                                return InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'DRAWER_TILE_NEW_Icon_w3ewgdlx_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_update_component_state');
                                                                    setState(
                                                                        () {
                                                                ...
                                                                return FlutterFlowIconButton(
                                                                  ...
                                                                  onPressed:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'DRAWER_TILE_NEW_COMP_settings_ICN_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'IconButton_update_component_state');
                                                                    setState(
                                                                        () {
                  ...
                  children: [
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'DRAWER_TILE_NEW_COMP_CANCEL_BTN_ON_TAP');
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'DRAWER_TILE_NEW_COMP_SAVE_BTN_ON_TAP');
