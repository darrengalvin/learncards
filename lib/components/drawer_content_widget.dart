                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'DRAWER_CONTENT_arrow_back_outlined_ICN_O');
                                  logFirebaseEvent(
                          ...
                          builder: (context) {
                            if (_model.isEdit) {
                              return InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'DRAWER_CONTENT_COMP_Icon_8h9y0vz8_ON_TAP');
                                  logFirebaseEvent(
                              ...
                              return FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'DRAWER_CONTENT_COMP_add_ICN_ON_TAP');
                                  logFirebaseEvent(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'DRAWER_CONTENT_Image_8opdyhge_ON_TAP');
                                            logFirebaseEvent(
                                          ...
                                          builder: (context) {
                                            if (valueOrDefault<bool>(
                                              ...
                                              return InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'DRAWER_CONTENT_COMP_Icon_lhdaugrl_ON_TAP');
                                                  logFirebaseEvent(
                                              ...
                                              return InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'DRAWER_CONTENT_COMP_Icon_6p6ppdic_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Icon_update_component_state');
                                                  setState(() {
                                                    _model.isEdit = false;
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'DRAWER_CONTENT_COMP_Text_onz2rp7f_ON_TAP');
                                                  logFirebaseEvent(
                                                              ...
                                                              if (valueOrDefault<
                                                                ...
                                                                return InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'DRAWER_CONTENT_COMP_Icon_08hk52gl_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_update_component_state');
                                                                    setState(
                                                                        () {
                                                                ...
                                                                return FlutterFlowIconButton(
                                                                  ...
                                                                  onPressed:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'DRAWER_CONTENT_COMP_settings_ICN_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'IconButton_update_component_state');
                                                                    setState(
                                                                        () {
                  ...
                  children: [
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'DRAWER_CONTENT_COMP_CANCEL_BTN_ON_TAP');
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'DRAWER_CONTENT_CREATE_APP_BTN_ON_TAP');
