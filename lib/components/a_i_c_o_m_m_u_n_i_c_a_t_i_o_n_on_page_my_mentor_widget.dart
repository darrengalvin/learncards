...
import 'a_i_c_o_m_m_u_n_i_c_a_t_i_o_n_on_page_my_mentor_model.dart';
export 'a_i_c_o_m_m_u_n_i_c_a_t_i_o_n_on_page_my_mentor_model.dart';

class AICOMMUNICATIONOnPageMyMentorWidget extends StatefulWidget {
  const AICOMMUNICATIONOnPageMyMentorWidget({
    super.key,
    bool? askingQuestion,
  ...
  @override
  State<AICOMMUNICATIONOnPageMyMentorWidget> createState() =>
      _AICOMMUNICATIONOnPageMyMentorWidgetState();
}

class _AICOMMUNICATIONOnPageMyMentorWidgetState
    extends State<AICOMMUNICATIONOnPageMyMentorWidget>
    with TickerProviderStateMixin {
  late AICOMMUNICATIONOnPageMyMentorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AICOMMUNICATIONOnPageMyMentorModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('A_I_C_O_M_M_U_N_I_C_A_T_I_O_N_ON_MY_MENT');
      logFirebaseEvent('AI_COMMUNICATION-OnPage-MyMentor_update_');
      setState(() {
        _model.questionReady = true;
      });
      logFirebaseEvent('AI_COMMUNICATION-OnPage-MyMentor_wait__d');
      await Future.delayed(const Duration(milliseconds: 500));
      logFirebaseEvent('AI_COMMUNICATION-OnPage-MyMentor_scroll_');
            ...
            child: StreamBuilder<List<MyTeamRecord>>(
              ...
              builder: (context, snapshot) {
                ...
                return InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent(
                        'A_I_C_O_M_M_U_N_I_C_A_T_I_O_N_ON_MY_MENT');
                    logFirebaseEvent('Container_update_component_state');
                    setState(() {
                      _model.showMemberDetails = false;
                    });
                  },
                  child: ClipRRect(
                            ...
                            child: Container(
                              ...
                              child: Stack(
                                children: [
                                                                          ...
                                                                          children: [
                                                                            FlutterFlowDropDown<String>(
                                                                              controller: _model.dropDownValueController2 ??= FormFieldController<String>(
                                                                                _model.dropDownValue2 ??= 'Reading Topic (thread)',
                                                                              ),
                                                                              options: [
                                                                                'Reading Topic (thread)'
                                                                              ],
                                                                            ...
                                                                            FFButtonWidget(
                                                                              onPressed: () async {
                                                                                ...
                                                                                setState(() {
                                                                                  FFAppState().selectedThreadId = random_data.randomString(
                                                                                    8,
                                                                                    10,
                                                                                    true,
                                                                                    true,
                                                                                ...
                                                                                // flowise chat document
                                                                                logFirebaseEvent('Button_flowisechatdocument');
                                                                                ...
                                                                                await flowiseChatsRecordReference.set(createFlowiseChatsRecordData(
                                                                                  ...
                                                                                  role: 'ai',
                                                                                  text: widget.companiesDoc?.youAreMyCoachPrompt,
                                                                                ...
                                                                                _model.initialchatCreated1 = FlowiseChatsRecord.getDocumentFromData(
                                                                                    createFlowiseChatsRecordData(
                                                                                      userId: loggedIn ? currentUserReference?.id : FFAppState().nonLoggedInSessionId,
                                                                                      role: 'ai',
                                                                                      text: widget.companiesDoc?.youAreMyCoachPrompt,
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return ListView
                                                                          ...
                                                                          scrollDirection:
                                                                              Axis.vertical,
                                                                          itemCount:
                                                                              columnChatsScrollableFlowiseChatsRecordList.length,
                                                                          separatorBuilder: (_, __) =>
                                                                              SizedBox(height: 8.0),
                                                                          itemBuilder:
                                                                              (context, columnChatsScrollableIndex) {
                                                                            final columnChatsScrollableFlowiseChatsRecord =
                                                                                columnChatsScrollableFlowiseChatsRecordList[columnChatsScrollableIndex];
                                                                            return Column(
                                                                              mainAxisSize: MainAxisSize.max,
                                                                              children: [
                                                                                if ((columnChatsScrollableFlowiseChatsRecord.role == 'human') && (columnChatsScrollableFlowiseChatsRecord.threadId == FFAppState().selectedThreadId) && (columnChatsScrollableFlowiseChatsRecord.sessionId == FFAppState().nonLoggedInSessionId))
                                                                                  Row(
                                                                                    mainAxisSize: MainAxisSize.max,
                                                                                ...
                                                                                if ((columnChatsScrollableFlowiseChatsRecord.role == 'ai') || (columnChatsScrollableFlowiseChatsRecord.role == 'system'))
                                                                                  Container(
                                                                                    width: double.infinity,
                                                                                    child: Stack(
                                                                                      children: [
                                                                                          ...
                                                                                          children: [
                                                                                            Flexible(
                                                                                              child: Column(
                                                                                                ...
                                                                                                children: [
                                                                                                  if (valueOrDefault<bool>(
                                                                                                    ((columnChatsScrollableFlowiseChatsRecord.role == 'ai') && (columnChatsScrollableFlowiseChatsRecord.threadId == FFAppState().selectedThreadId) && (columnChatsScrollableFlowiseChatsRecord.sessionId == FFAppState().nonLoggedInSessionId)) || (columnChatsScrollableFlowiseChatsRecord.showToAll == true),
                                                                                                    false,
                                                                                                  ))
                                                                                                    AnimatedContainer(
                                                                                                      duration: Duration(milliseconds: 100),
                                                                            ...
                                                                            children: [
                                                                              Expanded(
                                                                                child: TextFormField(
                                                                                  ...
                                                                                  validator: _model.askTheQuestionControllerValidator.asValidator(context),
                                                                                ),
                                                                              ),
                                                                              if (responsiveVisibility(
                                                                                context: context,
                                                                                ...
                                                                                FlutterFlowIconButton(
                                                                                  ...
                                                                                  onPressed: () async {
                                                                                    ...
                                                                                    _model.companyQueryByCode = await queryCompaniesRecordOnce(
                                                                                    ...
                                                                                    if (FFAppState().nonLoggedInSessionId == null || FFAppState().nonLoggedInSessionId == '') {}
                                                                                    // flowise chat document
                                                                                    ...
                                                                                    await FlowiseChatsRecord.collection.doc().set(createFlowiseChatsRecordData(
                                                                                          userId: loggedIn ? currentUserReference?.id : FFAppState().nonLoggedInSessionId,
                                                                                          role: 'human',
                                                                                          text: _model.askTheQuestionController.text,
                                                                                          createdTime: getCurrentTimestamp,
                                                                                          sessionId: FFAppState().nonLoggedInSessionId,
                                                                                          threadId: FFAppState().selectedThreadId,
                                                                                        ));
                                                                                    if (!(FFAppState().selectedThreadId != null && FFAppState().selectedThreadId != '')) {
                                                                                    ...
                                                                                    await actions.callFlowiseStreamingChat(
                                                                                      ...
                                                                                      FFAppState().nonLoggedInSessionId,
                                                                                      valueOrDefault<String>(
                                                                                        _model.companyQueryByCode?.first?.supabaseProjUrl,
                                                                                        'https://efdipbnxemvehcjbxekx.supabase.co',
                                                                                      ),
                                                                                      valueOrDefault<String>(
                                                                                        _model.companyQueryByCode?.first?.tableName,
                                                                                        'table_name',
                                                                                      ),
                                                                                      valueOrDefault<String>(
                                                                                        _model.companyQueryByCode?.first?.supabaseApiKey,
                                                                                        'apikey',
                                                                                      ),
                                                                                      valueOrDefault<String>(
                                                                                        _model.companyQueryByCode?.first?.queryName,
                                                                                        'queryName',
                                                                                      ),
                                                                                      valueOrDefault<bool>(
                                                                                        _model.companyQueryByCode?.first?.isLearnCards,
                                                                                        false,
                                                                                      ),
                                                                                      () async {
                                                                                        // scroll non streaming column
                                                                                        logFirebaseEvent('_scrollnonstreamingcolumn');
                                                                                        await _model.columnChatsScrollable?.animateTo(
                                                                                          _model.columnChatsScrollable!.position.maxScrollExtent,
                                                                                          duration: Duration(milliseconds: 100),
                                                                                          curve: Curves.ease,
                                                                                        ...
                                                                                        // scroll streaming
                                                                                        logFirebaseEvent('_scrollstreaming');
                                                                                        await _model.columnMarkdownScrollable?.animateTo(
                                                                                          _model.columnMarkdownScrollable!.position.maxScrollExtent,
                                                                                          duration: Duration(milliseconds: 100),
                                                                                          curve: Curves.ease,
                                                                                        );
                                                                                      },
                                                                              ...
                                                                              if (responsiveVisibility(
                                                                                ...
                                                                                FlutterFlowIconButton(
                                                                                  ...
                                                                                  onPressed: () async {
                                                                                    logFirebaseEvent('A_I_C_O_M_M_U_N_I_C_A_T_I_O_N_ON_MY_MENT');
                                                                                    logFirebaseEvent('IconButton_firestore_query');
                                                                                    _model.companyQueryByCode1 = await queryCompaniesRecordOnce(
                                                                                      queryBuilder: (companiesRecord) => companiesRecord.where(
                                                                                        'companyCode',
                                                                                        isEqualTo: valueOrDefault<String>(
                                                                                          FFAppState().companySecretCode,
                                                                                    ...
                                                                                    await actions.callFlowiseStreamingChat(
                                                                                      ...
                                                                                      FFAppState().nonLoggedInSessionId,
                                                                                      valueOrDefault<String>(
                                                                                        _model.companyQueryByCode1?.first?.supabaseProjUrl,
                                                                                        'https://efdipbnxemvehcjbxekx.supabase.co',
                                                                                      ),
                                                                                      valueOrDefault<String>(
                                                                                        _model.companyQueryByCode1?.first?.tableName,
                                                                                        'table_name',
                                                                                      ),
                                                                                      valueOrDefault<String>(
                                                                                        _model.companyQueryByCode1?.first?.supabaseApiKey,
                                                                                        'apikey',
                                                                                      ),
                                                                                      valueOrDefault<String>(
                                                                                        _model.companyQueryByCode1?.first?.queryName,
                                                                                        'queryName',
                                                                                      ),
                                                                                      valueOrDefault<bool>(
                                                                                        _model.companyQueryByCode1?.first?.isLearnCards,
                                                                                        false,
                                                                                      ),
                                                                                      () async {
                                                                                        // scroll non streaming column
                                                                                    ...
                                                                                    var flowiseChatsRecordReference2 = FlowiseChatsRecord.collection.doc();
                                                                                    await flowiseChatsRecordReference2.set(createFlowiseChatsRecordData(
                                                                                      userId: loggedIn ? currentUserReference?.id : FFAppState().nonLoggedInSessionId,
                                                                                      role: 'ai',
                                                                                      text: FFAppState().flowiseMessages.first.message,
                                                                                      createdTime: getCurrentTimestamp,
                                                                                    ...
                                                                                    _model.creeatedWelcomeChatDoc = FlowiseChatsRecord.getDocumentFromData(
                                                                                        createFlowiseChatsRecordData(
                                                                                          userId: loggedIn ? currentUserReference?.id : FFAppState().nonLoggedInSessionId,
                                                                                          role: 'ai',
                                                                                          text: FFAppState().flowiseMessages.first.message,
                                                                              ...
                                                                              FlutterFlowIconButton(
                                                                                ...
                                                                                borderWidth: 1.0,
                                                                                buttonSize: 55.0,
                                                                                fillColor: widget.companiesDoc?.colors?.primaryColor,
                                                                                icon: Icon(
                                                                                  Icons.send_sharp,
                                                                                  color: FlutterFlowTheme.of(context).primaryText,
                                                                                  size: 24.0,
                                                                                ...
                                                                                onPressed: () async {
                                                                                  logFirebaseEvent('A_I_C_O_M_M_U_N_I_C_A_T_I_O_N_ON_MY_MENT');
                                                                                  logFirebaseEvent('IconButton_firestore_query');
                                                                                  _model.companyQueryByCode2 = await queryCompaniesRecordOnce(
                                                                                    queryBuilder: (companiesRecord) => companiesRecord.where(
                                                                                      'companyCode',
                                                                                      isEqualTo: valueOrDefault<String>(
                                                                                        FFAppState().companySecretCode,
                                                                                  ...
                                                                                  var flowiseChatsRecordReference1 = FlowiseChatsRecord.collection.doc();
                                                                                  await flowiseChatsRecordReference1.set(createFlowiseChatsRecordData(
                                                                                    ...
                                                                                    sessionId: FFAppState().nonLoggedInSessionId,
                                                                                    threadId: FFAppState().selectedThreadId,
                                                                                    chatType: FFAppState().chatType,
                                                                                    companyDocId: _model.companyQueryByCode2?.first?.reference.id,
                                                                                    threadDetails: createThreadsStruct(
                                                                                      threadId: FFAppState().selectedThreadId,
                                                                                      threadName: containerMyTeamRecord?.memberName,
                                                                                      threadImage: containerMyTeamRecord?.image,
                                                                                      clearUnsetFields: false,
                                                                                      create: true,
                                                                                    ),
                                                                                  ));
                                                                                  _model.createdChat = FlowiseChatsRecord.getDocumentFromData(
                                                                                      createFlowiseChatsRecordData(
                                                                                        userId: valueOrDefault<String>(
                                                                                          FFAppState().nonLoggedInSessionId,
                                                                                          'notset',
                                                                                  ...
                                                                                  logFirebaseEvent('IconButton_firestore_query');
                                                                                  _model.showToAllChat = await queryFlowiseChatsRecordOnce(
                                                                                    queryBuilder: (flowiseChatsRecord) => flowiseChatsRecord
                                                                                        .where(
                                                                                          'showToAll',
                                                                                          isEqualTo: true,
                                                                                  ...
                                                                                  await actions.callFlowiseStreamingChat(
                                                                                    _model.askTheQuestionController.text,
                                                                                    'You are ${containerMyTeamRecord?.memberName} you are the users  ${containerMyTeamRecord?.role} your summary is ${containerMyTeamRecord?.memberSummary}your persona is ${containerMyTeamRecord?.persona} Words and phrases you use in your vocalabary are ${containerMyTeamRecord?.buzzWordsPhrases?.take(25).toList()?.first}: ${widget.companiesDoc?.youAreMyCoachPrompt}, you may have asked a question, if you did the user is following up from that question the question you asked is here  ${valueOrDefault<String>(
                                                                                      _model.showToAllChat?.text,
                                                                                      'no question asked',
                                                                                    )}if there is a question you must realise that the users next message will be answering it so tie the dots.',
                                                                                    '1',
                                                                                    FFAppState().selectedThreadId,
                                                                                    FFAppState().selectedThreadId,
                                                                                    valueOrDefault<String>(
                                                                                      _model.companyQueryByCode2?.first?.supabaseProjUrl,
                                                                                      'https://efdipbnxemvehcjbxekx.supabase.co',
                                                                                    ),
                                                                                    valueOrDefault<String>(
                                                                                      _model.companyQueryByCode2?.first?.tableName,
                                                                                      'table_name',
                                                                                    ),
                                                                                    valueOrDefault<String>(
                                                                                      _model.companyQueryByCode2?.first?.supabaseApiKey,
                                                                                      'apikey',
                                                                                    ),
                                                                                    valueOrDefault<String>(
                                                                                      _model.companyQueryByCode2?.first?.queryName,
                                                                                      'queryName',
                                                                                    ),
                                                                                    valueOrDefault<bool>(
                                                                                      _model.companyQueryByCode2?.first?.isLearnCards,
                                                                                      false,
                                                                                    ),
                                                                                    () async {
                                                                                      // scroll non streaming column
                                                      ...
                                                      children: [
                                                        if (valueOrDefault<
                                                          ...
                                                          FFButtonWidget(
                                                            onPressed:
                                                              ...
                                                              await widget
                                                                ...
                                                                ...mapToFirestore(
                                                                  {
                                                                    'learnCardCount':
                                                                        FieldValue.increment(widget.sessionsDoc!.learnCardCount >=
                                                                                1
                                                                            ? 0
                                                                            : 3),
                                                                  },
                                                            ...
                                                            text:
                                                                'Update Learn Count and NavPath',
                                                            options:
                                                                FFButtonOptions(
                                                              height: 50.0,
                                                              padding:
                                  ...
                                  if (_model.showMemberDetails == true)
                                    Align(
                                      alignment:
                                          AlignmentDirectional(0.0, -1.0),
                                      child: Padding(
