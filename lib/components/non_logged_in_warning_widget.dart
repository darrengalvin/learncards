...
import 'non_logged_in_warning_model.dart';
export 'non_logged_in_warning_model.dart';

class NonLoggedInWarningWidget extends StatefulWidget {
  const NonLoggedInWarningWidget({super.key});

  @override
  State<NonLoggedInWarningWidget> createState() =>
      _NonLoggedInWarningWidgetState();
}

class _NonLoggedInWarningWidgetState extends State<NonLoggedInWarningWidget> {
  late NonLoggedInWarningModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NonLoggedInWarningModel());
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'NON_LOGGED_IN_WARNING_SAVE_MY_PROGRESS_B');
                          ...
                          child: Visibility(
                            ...
                            child: AuthUserStreamWidget(
                              builder: (context) => FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'NON_LOGGED_IN_WARNING_MERGE_MY_PROGRESS_');
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'NON_LOGGED_IN_WARNING_Container_dk7ygzgb');
