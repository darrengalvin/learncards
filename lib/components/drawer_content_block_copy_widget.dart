...
import 'drawer_content_block_copy_model.dart';
export 'drawer_content_block_copy_model.dart';

class DrawerContentBlockCopyWidget extends StatefulWidget {
  const DrawerContentBlockCopyWidget({
    super.key,
    this.editBlockId,
  });
  ...
  @override
  State<DrawerContentBlockCopyWidget> createState() =>
      _DrawerContentBlockCopyWidgetState();
}

class _DrawerContentBlockCopyWidgetState
    extends State<DrawerContentBlockCopyWidget> {
  late DrawerContentBlockCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DrawerContentBlockCopyModel());
                        ...
                        child: Row(
                          ...
                          children: [
                            FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'DRAWER_CONTENT_BLOCK_COPY_CANCEL_BTN_ON_');
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'DRAWER_CONTENT_BLOCK_COPY_DELETE_BTN_ON_');
                                logFirebaseEvent('Button_backend_call');
                                await columnTileBlocksRecord!.reference
                                    .delete();
                                logFirebaseEvent('Button_update_app_state');
                                _model.updatePage(() {
                                  FFAppState().drawerBlockId = '';
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'DRAWER_CONTENT_BLOCK_COPY_SAVE_BTN_ON_TA');
                                logFirebaseEvent('Button_update_app_state');
                                _model.updatePage(() {
                                  FFAppState().drawerBlockId = '';
                                });
                                          ...
                                          builder: (context) {
                                            if (valueOrDefault<bool>(
                                              ...
                                              return wrapWithModel(
                                                model:
                                                    _model.editTextBlockModel,
                                                updateCallback: () =>
                                                    setState(() {}),
                                                updateOnChange: true,
                                                child: EditTextBlockWidget(
                                                  blockDoc:
                                                      columnTileBlocksRecord,
                                                ),
                                              );
                                                  ...
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'DRAWER_CONTENT_BLOCK_COPY_Text_bnbpjc0d_');
                                                          logFirebaseEvent(
