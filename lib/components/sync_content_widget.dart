...
import 'sync_content_model.dart';
export 'sync_content_model.dart';

class SyncContentWidget extends StatefulWidget {
  const SyncContentWidget({super.key});

  @override
  State<SyncContentWidget> createState() => _SyncContentWidgetState();
}

class _SyncContentWidgetState extends State<SyncContentWidget>
    with TickerProviderStateMixin {
  late SyncContentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SyncContentModel());
                    ...
                    child: Row(
                      ...
                      children: [
                        FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            logFirebaseEvent(
                                'SYNC_CONTENT_close_rounded_ICN_ON_TAP');
                                                ...
                                                children: [
                                                  Padding(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'SYNC_CONTENT_Container_o0ltwvj4_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Container_drawer');
                                                        Scaffold.of(context)
                                                            .openEndDrawer();
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'SYNC_CONTENT_Container_8k8ion1o_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Container_drawer');
                                                        Scaffold.of(context)
                                                            .openEndDrawer();
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'SYNC_CONTENT_Container_d9qngm77_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Container_drawer');
                                                        Scaffold.of(context)
                                                            .openEndDrawer();
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'SYNC_CONTENT_Container_fuhxx1hv_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Container_drawer');
                                                        Scaffold.of(context)
                                                            .openEndDrawer();
