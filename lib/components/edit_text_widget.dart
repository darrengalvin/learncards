...
class _EditTextWidgetState extends State<EditTextWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditTextModel());

    _model.editTextEntryController ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.editTextValue,
      'a text value',
    ));
    _model.editTextEntryFocusNode ??= FocusNode();
            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  child: TextFormField(
                    controller: _model.editTextEntryController,
                    ...
                    maxLines: null,
                    validator: _model.editTextEntryControllerValidator
                        .asValidator(context),
                  ),
                ),
              ),
