...
class FFAppState extends ChangeNotifier {
  ...
  Future initializePersistedState() async {
    ...
    _safeInit(() {
      _selectedCategoryId =
          prefs.getString('ff_selectedCategoryId') ?? _selectedCategoryId;
    });
    _safeInit(() {
  ...
  set selectedCategoryId(String _value) {
    _selectedCategoryId = _value;
    prefs.setString('ff_selectedCategoryId', _value);
  }

  bool _walkthroughComplete = false;
  bool get walkthroughComplete => _walkthroughComplete;
  set walkthroughComplete(bool _value) {
    _walkthroughComplete = _value;
    prefs.setBool('ff_walkthroughComplete', _value);
  }

  bool _wantsToLogin = false;
  bool get wantsToLogin => _wantsToLogin;
  set wantsToLogin(bool _value) {
    _wantsToLogin = _value;
  }
