                      ...
                      child: Column(
                        ...
                        children: [
                          FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'CREATE_PROFILE_chevron_left_ICN_ON_TAP');
                                  ...
                                  Align(
                                    ...
                                    child: AuthUserStreamWidget(
                                      builder: (context) => InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'CREATE_PROFILE_PAGE_profilepic_ON_TAP');
                                          logFirebaseEvent(
                                              'profilepic_upload_media_to_firebase');
                                          final selectedMedia =
                                  ...
                                  Align(
                                    ...
                                    child: AuthUserStreamWidget(
                                      builder: (context) => InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'CREATE_PROFILE_profilepicNONE_ON_TAP');
                                          logFirebaseEvent(
                                              'profilepicNONE_upload_media_to_firebase');
                                          final selectedMedia =
                                              await selectMediaWithSourceBottomSheet(
                                            context: context,
                                            allowPhoto: true,
                                ...
                                if (_model.uploadedFileUrl2 != null &&
                                  ...
                                  Align(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'CREATE_PROFILE_PAGE_Imageuploaded_ON_TAP');
                                        logFirebaseEvent(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Image.network(
                                          valueOrDefault<String>(
                                            _model.uploadedFileUrl3,
                                            'https://ceris-gratton-jones.com/wp-content/uploads/2018/10/profile-picture-placeholder.png',
                                          ),
                                          width: 180.0,
                                          height: 180.0,
                                          fit: BoxFit.cover,
