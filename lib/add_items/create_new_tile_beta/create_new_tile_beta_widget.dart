...
class CreateNewTileBetaWidget extends StatefulWidget {
  const CreateNewTileBetaWidget({
    super.key,
    this.tilesdoc,
    this.tileref,
  });
  ...
  @override
  State<CreateNewTileBetaWidget> createState() =>
      _CreateNewTileBetaWidgetState();
}

class _CreateNewTileBetaWidgetState extends State<CreateNewTileBetaWidget> {
  late CreateNewTileBetaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateNewTileBetaModel());
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'CREATE_NEW_TILE_BETA_close_rounded_ICN_O');
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'CREATE_NEW_TILE_BETA_Image_3qhvonl4_ON_T');
                                              logFirebaseEvent(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        FFButtonWidget(
                                                          onPressed: () async {
                                                            logFirebaseEvent(
                                                                'CREATE_NEW_TILE_BETA_ASSIGN_BTN_ON_TAP');
                                                            logFirebaseEvent(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return ListView.builder(
                                            ...
                                            itemBuilder:
                                              ...
                                              final groupsListCategoriesRecord =
                                                  groupsListCategoriesRecordList[
                                                      groupsListIndex];
                                              return Padding(
                                                padding: EdgeInsetsDirectional
                                                            ...
                                                            child:
                                                              ...
                                                              builder: (context) =>
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'CREATE_NEW_TILE_BETA_REMOVE_BTN_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Button_show_snack_bar');
                  ...
                  Row(
                    ...
                    children: [
                      Theme(
                        ...
                        child: Checkbox(
                          value: _model.isFeaturedValue1 ??= false,
                          onChanged: (newValue) async {
                            setState(() => _model.isFeaturedValue1 = newValue!);
                          },
                    ...
                    Row(
                      ...
                      children: [
                        Theme(
                          ...
                          child: Checkbox(
                            value: _model.isFeaturedValue2 ??= false,
                            onChanged: (newValue) async {
                              setState(
                                  () => _model.isFeaturedValue2 = newValue!);
                            },
                            activeColor: FlutterFlowTheme.of(context).primary,
                          ),
                        ),
                ...
                children: [
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'CREATE_NEW_TILE_BETA_CREATE_TILE_BTN_ON_');
                        logFirebaseEvent('Button_backend_call');

                        var tilesRecordReference = TilesRecord.collection.doc();
                        await tilesRecordReference.set({
                          ...createTilesRecordData(
                            title: _model.titleTitleController.text,
                            summary: _model.descriptionController.text,
                            image: _model.uploadedFileUrl,
                            tier: 0,
                            id: 0,
                            showvideoslider: true,
                            show: true,
                            isFeatured: _model.isFeaturedValue1,
                            isAI: _model.isFeaturedValue2,
                          ),
                          ...mapToFirestore(
                            {
                              'memberlevels': _model.selectedGroups
                                  .map((e) => e.id)
                                  .toList(),
                            },
                          ),
                        ...
                        if (_model.selectedUsers?.id != null &&
                            _model.selectedUsers?.id != '') {
                          logFirebaseEvent('Button_backend_call');

                          await _model.newlycreatedtile!.reference
                              .update(createTilesRecordData(
                            tileref: _model.newlycreatedtile?.reference,
