...
import 'add_document_to_tile_model.dart';
export 'add_document_to_tile_model.dart';

class AddDocumentToTileWidget extends StatefulWidget {
  const AddDocumentToTileWidget({
    super.key,
    this.tileref,
  });
  ...
  @override
  State<AddDocumentToTileWidget> createState() =>
      _AddDocumentToTileWidgetState();
}

class _AddDocumentToTileWidgetState extends State<AddDocumentToTileWidget>
    with TickerProviderStateMixin {
  late AddDocumentToTileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddDocumentToTileModel());
                      ...
                      children: [
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'ADD_DOCUMENT_TO_TILE_Icon_mgzh2ino_ON_TA');
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'ADD_DOCUMENT_TO_TILE_UPLOAD_DOCUMENT_BTN');
                                      logFirebaseEvent(
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'ADD_DOCUMENT_TO_TILE_SUBMIT_BTN_ON_TAP');
