...
import 'event_app_tiles_widget.dart' show EventAppTilesWidget;
import 'package:flutter/material.dart';

class EventAppTilesModel extends FlutterFlowModel<EventAppTilesWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in EventAppTiles widget.
