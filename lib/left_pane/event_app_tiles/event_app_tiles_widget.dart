...
import 'event_app_tiles_model.dart';
export 'event_app_tiles_model.dart';

class EventAppTilesWidget extends StatefulWidget {
  const EventAppTilesWidget({
    super.key,
  ...
  @override
  State<EventAppTilesWidget> createState() => _EventAppTilesWidgetState();
}

class _EventAppTilesWidgetState extends State<EventAppTilesWidget> {
  late EventAppTilesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EventAppTilesModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('EVENT_APP_TILES_EventAppTiles_ON_INIT_ST');
      logFirebaseEvent('EventAppTiles_firestore_query');
      _model.tilesOriginal = await queryTilesRecordOnce();
      logFirebaseEvent('EventAppTiles_update_app_state');
      setState(() {
                                                                                      ...
                                                                                      children: [
                                                                                        Padding(
                                                                                          ...
                                                                                          child: InkWell(
                                                                                            ...
                                                                                            onTap: () async {
                                                                                              logFirebaseEvent('EVENT_APP_TILES_COMP_tileTier_ON_TAP');
                                                                                              if (FFAppState().tileNav.tier1Id == tilesParentsItem.reference.id) {
                                                                                                ...
                                                                                                setState(() {
                                                                                                  ...
                                                                                                  FFAppState().viewTileContentId = tilesParentsItem.reference.id;
                                                                                                ...
                                                                                                logFirebaseEvent('tileTier_alert_dialog');
                                                                                                await showDialog(
                                                                                                  context: context,
                                                                                                ...
                                                                                                FFAppState().updateTileNavStruct(
                                                                                                  (e) => e
                                                                                                    ..tier1Id = tilesParentsItem.reference.id
                                                                                                    ..tier2Id = null
                                                                                                    ..tier3Id = null
                                                                                                    ..tier4Id = null,
                                                                                                );
                                                                                                ...
                                                                                                logFirebaseEvent('tileTier_update_app_state');
                                                                                                _model.updatePage(() {
                                                                                                  FFAppState().addToNavPath(tilesParentsItem.reference.id);
                                                                                                });
                                                                                                logFirebaseEvent('tileTier_update_app_state');
                                                                                                setState(() {
                                                                                                  FFAppState().NewTileJustCreated = false;
                                                                                              ...
                                                                                              logFirebaseEvent('tileTier_update_app_state');
                                                                                              FFAppState().selectedTopic = tilesParentsItem.title;
                                                                                              FFAppState().selectedReadingItem = desktopTileNavTilesRecordList.first.title;
                                                                                              ...
                                                                                              decoration: BoxDecoration(
                                                                                                ...
                                                                                                border: Border.all(
                                                                                                  color: valueOrDefault<Color>(
                                                                                                    FFAppState().tileNav.tier1Id == tilesParentsItem.reference.id ? FlutterFlowTheme.of(context).customColor7 : FlutterFlowTheme.of(context).selectedButton,
                                                                                                                        ...
                                                                                                                        children: [
                                                                                                                          AutoSizeText(
                                                                                                                            valueOrDefault<String>(
                                                                                                                              'Date : ${tilesParentsItem.dateadded?.toString()}',
                                                                                                                              'not set',
                                                                                                                            ),
                                                                                                          ...
                                                                                                          if (valueOrDefault<bool>(
                                                                                                            ...
                                                                                                            AuthUserStreamWidget(
                                                                                                              builder: (context) => InkWell(
                                                                                                                ...
                                                                                                                highlightColor: Colors.transparent,
                                                                                                                onTap: () async {
                                                                                                                  logFirebaseEvent('EVENT_APP_TILES_Icon_y5nq2lpt_ON_TAP');
                                                                                                          ...
                                                                                                          if (valueOrDefault<bool>(
                                                                                                            ...
                                                                                                            AuthUserStreamWidget(
                                                                                                              builder: (context) => InkWell(
                                                                                                                ...
                                                                                                                highlightColor: Colors.transparent,
                                                                                                                onTap: () async {
                                                                                                                  logFirebaseEvent('EVENT_APP_TILES_Icon_ng6e47lh_ON_TAP');
                                                                                                        ...
                                                                                                        children: List.generate(tileTier2.length, (tileTier2Index) {
                                                                                                          ...
                                                                                                          return Padding(
                                                                                                            ...
                                                                                                            child: InkWell(
                                                                                                              ...
                                                                                                              highlightColor: Colors.transparent,
                                                                                                              onTap: () async {
                                                                                                                logFirebaseEvent('EVENT_APP_TILES_COMP_tile_ON_TAP');
                                                                                                                              ...
                                                                                                                              Padding(
                                                                                                                                ...
                                                                                                                                child: AuthUserStreamWidget(
                                                                                                                                  builder: (context) => InkWell(
                                                                                                                                    ...
                                                                                                                                    highlightColor: Colors.transparent,
                                                                                                                                    onTap: () async {
                                                                                                                                      logFirebaseEvent('EVENT_APP_TILES_Icon_n94au81o_ON_TAP');
                                                                                                                                      logFirebaseEvent('Icon_update_app_state');
                                                                                                                                      setState(() {
                                                                                                                                        FFAppState().drawerStartTab = 1;
                                                                                                                              ...
                                                                                                                              Padding(
                                                                                                                                ...
                                                                                                                                child: AuthUserStreamWidget(
                                                                                                                                  builder: (context) => InkWell(
                                                                                                                                    ...
                                                                                                                                    highlightColor: Colors.transparent,
                                                                                                                                    onTap: () async {
                                                                                                                                      logFirebaseEvent('EVENT_APP_TILES_Icon_skre7zzh_ON_TAP');
                                                                                                                                      logFirebaseEvent('Icon_alert_dialog');
                                                                                                                                      var confirmDialogResponse = await showDialog<bool>(
                                                                                                                                            context: context,
                                                                                                                                            builder: (alertDialogContext) {
