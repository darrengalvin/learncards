...
import 'add_video_model.dart';
export 'add_video_model.dart';
...
class _AddVideoWidgetState extends State<AddVideoWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddVideoModel());
                      ...
                      children: [
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'ADD_VIDEO_COMP_Icon_jsbja4lb_ON_TAP');
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'ADD_VIDEO_COMP_UPLOAD_VIDEO_BTN_ON_TAP');
                                      logFirebaseEvent(
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          padding: EdgeInsets.all(10.0),
                          child: Text(
                            'This will be important when a user is using the search facility, if you do not select a user level then it the item will be made avliable to all on search. ',
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'ADD_VIDEO_COMP_CREATE_BTN_ON_TAP');
                              ...
                              StreamBuilder<List<CategoriesRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<CategoriesRecord>
                                      memberListViewCategoriesRecordList =
                                      snapshot.data!;
                                  return ListView.builder(
                                    ...
                                    itemCount:
                                        memberListViewCategoriesRecordList
                                            .length,
                                    itemBuilder:
                                        (context, memberListViewIndex) {
                                      final memberListViewCategoriesRecord =
                                          memberListViewCategoriesRecordList[
                                              memberListViewIndex];
                                      return Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                                    ...
                                                    child: Theme(
                                                      ...
                                                      child: CheckboxListTile(
                                                        value: _model
                                                            ...
                                                            memberListViewCategoriesRecord] ??= false,
                                                        onChanged:
                                                            (newValue) async {
                                                          setState(() => _model
                                                                      .checkboxListTileValueMap1[
                                                                  memberListViewCategoriesRecord] =
                                                              newValue!);
                                                        },
                                                        title: Text(
                                                          memberListViewCategoriesRecord
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          padding: EdgeInsets.all(10.0),
                          child: Text(
                            'You can add this item to additional tiles if you wish to save you having to duplicate the work. Simply select the aditional tile here.  \n\nIf you do not require this just hit create and we will add it to the tile you are on ONLY.  ',
                            textAlign: TextAlign.center,
                            style: FlutterFlowTheme.of(context)
                                .titleSmall
                                .override(
                              ...
                              StreamBuilder<List<TilesRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    scrollDirection: Axis.vertical,
                                    itemCount:
                                        tileListViewTilesRecordList.length,
