...
import 'a_i_c_o_m_m_u_n_i_c_a_t_i_o_n_deletesoon_model.dart';
export 'a_i_c_o_m_m_u_n_i_c_a_t_i_o_n_deletesoon_model.dart';

class AICOMMUNICATIONDeletesoonWidget extends StatefulWidget {
  const AICOMMUNICATIONDeletesoonWidget({
    super.key,
    bool? askingQuestion,
    this.learnCard,
    this.learnCardId,
  ...
  @override
  State<AICOMMUNICATIONDeletesoonWidget> createState() =>
      _AICOMMUNICATIONDeletesoonWidgetState();
}

class _AICOMMUNICATIONDeletesoonWidgetState
    extends State<AICOMMUNICATIONDeletesoonWidget>
    with TickerProviderStateMixin {
  late AICOMMUNICATIONDeletesoonModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AICOMMUNICATIONDeletesoonModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('A_I_C_O_M_M_U_N_I_C_A_T_I_O_N_DELETESOON');
      logFirebaseEvent('AI_COMMUNICATION-deletesoon_update_compo');
      setState(() {
        _model.questionReady = true;
      });
      logFirebaseEvent('AI_COMMUNICATION-deletesoon_wait__delay');
      await Future.delayed(const Duration(milliseconds: 2000));
      logFirebaseEvent('AI_COMMUNICATION-deletesoon_scroll_to');
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'A_I_C_O_M_M_U_N_I_C_A_T_I_O_N_DELETESOON');
                                      logFirebaseEvent(
