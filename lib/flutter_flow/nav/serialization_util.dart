      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case WatermillOffsetsMessageTokenCountRow:
            return WatermillOffsetsMessageTokenCountRow(data);
          case WatermillPoisonQueueRow:
            return WatermillPoisonQueueRow(data);
          case WatermillMessageNerRow:
            return WatermillMessageNerRow(data);
          case WatermillMessageTokenCountRow:
            return WatermillMessageTokenCountRow(data);
          case WatermillOffsetsMessageSummarizerRow:
            return WatermillOffsetsMessageSummarizerRow(data);
          case WatermillOffsetsMessageSummaryEmbedderRow:
            return WatermillOffsetsMessageSummaryEmbedderRow(data);
          case WatermillMessageIntentRow:
            return WatermillMessageIntentRow(data);
          case WatermillMessageEmbedderRow:
            return WatermillMessageEmbedderRow(data);
          case WatermillMessageSummaryNerRow:
            return WatermillMessageSummaryNerRow(data);
          case WatermillMessageSummaryEmbedderRow:
            return WatermillMessageSummaryEmbedderRow(data);
          case WatermillOffsetsMessageIntentRow:
            return WatermillOffsetsMessageIntentRow(data);
          case WatermillMessageSummarizerRow:
            return WatermillMessageSummarizerRow(data);
          case WatermillOffsetsMessageEmbedderRow:
            return WatermillOffsetsMessageEmbedderRow(data);
          case MessageEmbeddingRow:
            return MessageEmbeddingRow(data);
          case BunMigrationsRow:
            return BunMigrationsRow(data);
          case WatermillOffsetsMessageSummaryNerRow:
            return WatermillOffsetsMessageSummaryNerRow(data);
          case SummaryRow:
            return SummaryRow(data);
          case WatermillDocumentEmbedderRow:
            return WatermillDocumentEmbedderRow(data);
          case DocumentCollectionRow:
            return DocumentCollectionRow(data);
          case UsersRow:
            return UsersRow(data);
          case MessageRow:
            return MessageRow(data);
          case WatermillOffsetsDocumentEmbedderRow:
            return WatermillOffsetsDocumentEmbedderRow(data);
          case BunMigrationLocksRow:
            return BunMigrationLocksRow(data);
          case SummaryEmbeddingRow:
            return SummaryEmbeddingRow(data);
          case WatermillOffsetsMessageNerRow:
            return WatermillOffsetsMessageNerRow(data);
          default:
            return null;
        }
