...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => _RouteErrorBuilder(
        ...
        child: RootPageContext.wrap(
          appStateNotifier.loggedIn ? DemoWidget() : LibraryFixedWidget(),
          ...
          routes: [
            ...
            FFRoute(
              ...
              asyncParams: {
                ...
                'sessionDoc': getDoc(['sessions'], SessionsRecord.fromSnapshot),
              },
              builder: (context, params) => ChatPageWidget(
                companiesDoc:
                    params.getParam('companiesDoc', ParamType.Document),
                sessionsDoc: params.getParam('sessionsDoc', ParamType.Document),
                sessionDoc: params.getParam('sessionDoc', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'login',
